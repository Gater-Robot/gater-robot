/**
 * GoldMedalIcon - A gold medal icon for the faucet page
 *
 * SVG component with gold gradient styling.
 * Used to represent token claiming achievements.
 */
...
export function GoldMedalIcon({ size = 64, className, ...props }: GoldMedalIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Ribbon left */}
      <path
        d="M22 8L18 2L26 2L30 8Z"
        fill="url(#ribbonGradient)"
      />

      {/* Ribbon right */}
      <path
        d="M42 8L38 2L46 2L42 8Z"
        fill="url(#ribbonGradient)"
      />

      {/* Ribbon center connector */}
